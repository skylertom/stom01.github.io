...
//orange line is vertical
//blue line is sort of a "J" shape
//red line splits at bottom (an upside down "Y" shape)
...
function displayInfo(myMarker) {
	// holds array of trains: lineData["schedule"]
	var contentString = 
		'<h1>' + myMarker.getTitle() + '</h1>' +
		'<div class="inbound"> <h2>Inbound</h2>' +
		'</div>'
		'<div class="outbound"> <h2>Outbound</h2>' +
		'</div>'
		;
